  ...
  return (
    <html lang="en">
      ...
      <body className="flex min-h-screen w-full flex-col antialiased">
        <Providers>
          {/* Mobile blocking overlay - shows on screens smaller than 640px */}
          <div className="fixed inset-0 z-50 bg-black flex items-center justify-center p-6 sm:hidden">
          ...
          {/* Main app content - hidden on small screens */}
